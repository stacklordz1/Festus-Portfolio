    ...
    return (
        <div className="flex items-center gap-2">
            <motion.div
                ...
                className="h-10 w-10 rounded-full border border-neutral-300 bg-gradient-to-b from-neutral-400 to-neutral-300" />
            <motion.div
                initial={{
                    y: 0,
                }}
            ...
            <motion.div
                ...
                className="h-7 w-7 rounded-full border border-neutral-300 bg-gradient-to-b from-neutral-400 to-neutral-300" />
        </div>
    );
};
